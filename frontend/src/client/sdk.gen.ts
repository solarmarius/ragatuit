...
import type { AuthLoginCanvasResponse, AuthAuthCanvasResponse, AuthLogoutCanvasResponse, CanvasGetCoursesResponse, CanvasGetCourseModulesData, CanvasGetCourseModulesResponse, CanvasGetModuleItemsData, CanvasGetModuleItemsResponse, CanvasGetPageContentData, CanvasGetPageContentResponse, CanvasGetFileInfoData, CanvasGetFileInfoResponse, QuestionsGetQuizQuestionsData, QuestionsGetQuizQuestionsResponse, QuestionsCreateQuestionData, QuestionsCreateQuestionResponse, QuestionsGetQuestionData, QuestionsGetQuestionResponse, QuestionsUpdateQuestionData, QuestionsUpdateQuestionResponse, QuestionsDeleteQuestionData, QuestionsDeleteQuestionResponse, QuestionsApproveQuestionData, QuestionsApproveQuestionResponse, QuestionsGenerateQuestionsData, QuestionsGenerateQuestionsResponse, QuestionsBatchGenerateQuestionsData, QuestionsBatchGenerateQuestionsResponse, QuizGetUserQuizzesEndpointResponse, QuizCreateNewQuizData, QuizCreateNewQuizResponse, QuizGetQuizData, QuizGetQuizResponse, QuizDeleteQuizEndpointData, QuizDeleteQuizEndpointResponse, QuizTriggerContentExtractionData, QuizTriggerContentExtractionResponse, QuizTriggerQuestionGenerationData, QuizTriggerQuestionGenerationResponse, QuizGetQuizQuestionStatsData, QuizGetQuizQuestionStatsResponse, QuizExportQuizToCanvasData, QuizExportQuizToCanvasResponse, UsersReadUserMeResponse, UsersDeleteUserMeResponse, UsersUpdateUserMeData, UsersUpdateUserMeResponse, UtilsHealthCheckResponse } from './types.gen';
...
export class CanvasService {
     ...
     * @throws ApiError
     */
    public static getCourseModules(data: CanvasGetCourseModulesData): CancelablePromise<CanvasGetCourseModulesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getModuleItems(data: CanvasGetModuleItemsData): CancelablePromise<CanvasGetModuleItemsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getPageContent(data: CanvasGetPageContentData): CancelablePromise<CanvasGetPageContentResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getFileInfo(data: CanvasGetFileInfoData): CancelablePromise<CanvasGetFileInfoResponse> {
        return __request(OpenAPI, {
            method: 'GET',
...
export class QuestionsService {
     ...
     * @throws ApiError
     */
    public static getQuizQuestions(data: QuestionsGetQuizQuestionsData): CancelablePromise<QuestionsGetQuizQuestionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getQuestion(data: QuestionsGetQuestionData): CancelablePromise<QuestionsGetQuestionResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static approveQuestion(data: QuestionsApproveQuestionData): CancelablePromise<QuestionsApproveQuestionResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
     ...
     * @throws ApiError
     */
    public static generateQuestions(data: QuestionsGenerateQuestionsData): CancelablePromise<QuestionsGenerateQuestionsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static batchGenerateQuestions(data: QuestionsBatchGenerateQuestionsData): CancelablePromise<QuestionsBatchGenerateQuestionsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
...
export class QuizService {
     ...
     * @throws ApiError
     */
    public static createNewQuiz(data: QuizCreateNewQuizData): CancelablePromise<QuizCreateNewQuizResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/quiz/',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static getQuiz(data: QuizGetQuizData): CancelablePromise<QuizGetQuizResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static deleteQuizEndpoint(data: QuizDeleteQuizEndpointData): CancelablePromise<QuizDeleteQuizEndpointResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/quiz/{quiz_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static triggerContentExtraction(data: QuizTriggerContentExtractionData): CancelablePromise<QuizTriggerContentExtractionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static triggerQuestionGeneration(data: QuizTriggerQuestionGenerationData): CancelablePromise<QuizTriggerQuestionGenerationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getQuizQuestionStats(data: QuizGetQuizQuestionStatsData): CancelablePromise<QuizGetQuizQuestionStatsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static exportQuizToCanvas(data: QuizExportQuizToCanvasData): CancelablePromise<QuizExportQuizToCanvasResponse> {
        return __request(OpenAPI, {
            method: 'POST',
