...
import type {
  ...
  QuestionsGetQuizQuestionStatsData,
  QuestionsGetQuizQuestionStatsResponse,
...
export class QuestionsService {
  ...
  public static getQuizQuestionStats(
    data: QuestionsGetQuizQuestionStatsData
  ): CancelablePromise<QuestionsGetQuizQuestionStatsResponse> {
    return __request(OpenAPI, {
      method: "GET",
