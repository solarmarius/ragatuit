...
test.describe('Quiz List Component', () => {
  ...
  test('should display empty state when no quizzes exist', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Create Your First Quiz' })).toBeVisible();
  });
  ...
  test('should display quiz list with all information', async ({ page }) => {
    ...
    const mockQuizzes = [
      {
        ...
        selected_modules: '{"173467": "Neural Networks", "173468": "Deep Learning"}',
        question_count: 50,
        llm_model: 'gpt-4o',
        llm_temperature: 0.7,
      ...
      },
      {
        ...
        selected_modules: '{"173469": "Variables", "173470": "Functions", "173471": "Classes"}',
        question_count: 25,
        llm_model: 'o3-pro',
        llm_temperature: 0.3,
    ...
    await expect(page.getByText('Manage and view all your created quizzes')).toBeVisible();
